...
# engine = create_engine('mysql+pymysql://'+db_username+':'+db_password+'@'+db_host+':'+str(db_port)+'/'+db_database,echo=True,connect_args={'charset':'utf8'})
...
class Grade(base):
    ...
    grade_stu_id = Column(Integer,ForeignKey("student.stu_id"))
    grade_cou_id = Column(Integer,ForeignKey("course.cou_id"))
    score = Column(Float)
